const translations = {
  en: {
    ...
    managerFeatureThreeTitle: "Updates are not imports",
    managerFeatureThreeBody: "The catalog can refresh automatically; you still confirm the final import in ChatGPT Appearance.",
  ...
  "zh-CN": {
    ...
    managerFeatureThreeTitle: "更新与导入分开",
    managerFeatureThreeBody: "目录可自动同步；最终导入仍由你在 ChatGPT 外观设置中确认。",
