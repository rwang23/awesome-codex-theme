const translations = {
  en: {
    ...
    capabilityNative: "ACT Full Skin v1 is verified with ChatGPT Beta 26.715.3651.0 and 5.6 Sol Ultra across all 106 theme modes. It applies the background, materials, colors, and theme copy; Native v1 remains a palette-only fallback.",
  ...
  "zh-CN": {
    ...
    capabilityNative: "ACT Full Skin v1 已使用 ChatGPT Beta 26.715.3651.0 与 5.6 Sol Ultra 完成全部 106 个模式的实机验证，可应用背景、材质、配色和主题文字；Native v1 只保留为配色回退。",
    resultCount: "套主题",
    allCollections: "全部系列",
