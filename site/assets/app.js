const translations = {
  en: {
    ...
    managerIntro: "The Tauri Theme Manager validates the remote Registry and keeps the last verified catalog offline. On Windows, users can opt into Always apply so verified future launches restore the theme without patching app files.",
  ...
  "zh-CN": {
    ...
    managerIntro: "Tauri Theme Manager 会校验远端 Registry；Windows 还可由用户主动开启“始终应用”，在以后打开已验证版本时安全恢复主题，不修改应用文件。",
