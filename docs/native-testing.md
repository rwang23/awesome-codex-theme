...
`scripts/capture-full-skin-screenshots.mjs` 对 41 套主题的明亮、暗色模式依次执行：
...
结果是 82/82 捕获成功，`fixture.project` 为 `none`，
...
82 张截图会按模式生成 contact sheet。抽检关注：
